...
<head>
    ...
    {{-- fav icon --}}
    <title>403 Error - No Permission</title>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-6">
                            <div class="text-center mt-4">
                                ...
                                <p class="lead">প্রবেশ নিষিদ্ধ</p>
                                <p class="lead">দুঃখিত! আপনার রোল পারমিশন অনুযায়ী এই পেজটি দেখাবার/পরিবর্তন করবার কোনো সুযোগ নাই।</p>
                                <a href="{{ url()->previous() }}">
