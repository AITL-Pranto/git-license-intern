@extends('backend.global.master', ['menu' => 'manage_admin'])
@section('title', __('ব্যবহারকারী(অ্যাডমিন)'))
...
@section('backend_content')
    <main>
        <div class="container-fluid px-4">
            <h1 class="mt-4">ব্যবহারকারী(অ্যাডমিন)</h1>
            <ol class="breadcrumb mb-4">
                <li class="breadcrumb-item active">ব্যবহারকারী(অ্যাডমিন)</li>
            </ol>
                ...
                <div class="card-header">
                    ...
                    <button data-id="add_id" data-bs-toggle="modal" data-bs-target="#form_modal"
                        class="btn m-b-xs btn-sm btn-primary btn-addon float-end" id="add_btn"><i
                            class="fa fa-plus"></i>নতুন অ্যাডমিন যুক্ত করুন
                    </button>
                </div>
                <div class="card-body">
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <a href="{{ url('admin/admin-user/inactive/' . $user->id) }}"
            ...
            <div class="modal fade" id="form_modal" tabindex="-1" aria-labelledby="form_modal" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        {!! Form::open(['url' => '/admin/save-admin-user', 'id' => 'modal_form', 'files' => true]) !!}
            ...
            $("#add_btn").click(function() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        $('.modal-title').html('নতুন অ্যাডমিন যুক্ত করুন');
