@extends('backend.auth.auth_master', ['menu' => ''])
@section('title', __('messages.page_title.login_page_title'))

@section('backend_auth_custom_stylesheet')
@stop

@section('backend_auth_content')
    @php
                        ...
                        <div class="col-lg-5">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                ...
                                <div class="card-body">
                                    ...
                                    {!! Form::open(array('url'=>'/admin/login-request','class'=>"login")) !!}
...
@section('backend_auth_custom_scripts')
