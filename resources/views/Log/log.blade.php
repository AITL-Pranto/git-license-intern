...
<head>
  ...
  <title>KCC CATTLE HAT LOG VIEWER</title>
  <link rel="stylesheet"
...
<div class="container-fluid">
  <div class="row">
    <div class="col sidebar mb-3">
      <h1><i class="fa fa-calendar" aria-hidden="true"></i> KCC CATTLE HAT</h1>
      <p class="text-muted"><i>by KCC</i></p>
          ...
          @foreach($logs as $key => $log)
            <tr data-display="stack{{{$key}}}">
              @if ($standardFormat)
                ...
                <td class="text">
                    <span class="badge badge-success">{{$log['context']}}</span>
                </td>
              @endif
              <td class="date">
                @if ($standardFormat)
