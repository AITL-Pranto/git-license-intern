...
class AuthController extends Controller
{
    ...
    public function adminLogin(Request $request)
    {
        try {
            ...
            $get_Attempted_DB_UserDetails = User::where('user_type', UserTypeEnum::ADMIN);
                        ...
                        if ($get_Attempted_DB_UserDetails->user_type == UserTypeEnum::ADMIN) {
                            if ($get_Attempted_DB_UserDetails->user_status == UserTypeEnum::ACTIVE_USER) {
                                ...
                                if (filter_var($request->email_or_mobile, FILTER_VALIDATE_EMAIL)) {
                                    ...
                                    if (Auth::attempt(['phone' => $request->email_or_mobile, 'password' => $request->password, 'user_type' => UserTypeEnum::ADMIN])) {
                                        return redirect()->route('viewAdminDashboard');
                                    }
                                }
                            } else {
